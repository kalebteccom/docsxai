...
An architectural characteristic docsxai cares about gets an automated check that
**fails when the characteristic regresses**. It is the answer to "what breaks if
my change is not as boundary-respecting as I think it is."
